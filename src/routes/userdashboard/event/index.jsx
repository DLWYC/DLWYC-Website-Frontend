...
export const Route = createFileRoute('/userdashboard/event/')({
...
function SingleEvent() {
  ...
  useEffect(() => {
    ...
    console.log("Cached Events: ", search)
...
//         const numberfPeopleToBePayedFor = paymentOption === 'multiple' 
...
//         if (paymentOption === 'multiple' && numberfPeopleToBePayedFor > 0) {
